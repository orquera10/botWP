...
- despues de acreditarse la seña de una reserva de cumpleaños, solicita el primer nombre del cumpleañero; detecta el nombre aunque aparezca después del apellido y, cuando reconoce un posible nombre compuesto como `Maria Jose`, pregunta si debe usar el primero o conservar ambos
